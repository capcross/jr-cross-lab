...
const App = () => {
  let impl = jrwidgets.toolbar;
  console.log('App: impl = ' + impl);
  return (
    <JRBoard widgets={jrwidgets} render={(workstate, actions) => (
      <React.Fragment>
        <Toolbar impl={impl} renderButtons = { () => {
          console.log('App_1: impl = ' + impl);
          return (
            <React.Fragment>
              <ViewButton widget={jrwidgets.toolbarButton} workstate={workstate} onClick={actions.view}/>
